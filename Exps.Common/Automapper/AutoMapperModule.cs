...
namespace Exps.Common.AutoMapper
{
    public class AutoMapperModule : Autofac.Module
    {
      ...
      protected override void Load(ContainerBuilder builder)
      {
        ...
        allTypes.Where(t => t.IsClass && !t.IsAbstract && ImplementsGenericInterface(t.AsType(), openType))))
       {
        ...
        builder.Register<IMapper>(ctx => new global::AutoMapper.Mapper(ctx.Resolve<IConfigurationProvider>(), ctx.Resolve)).InstancePerDependency();
     }
